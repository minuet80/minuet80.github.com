...
### ✔ IT 전문가 800명이 선정한 투자 유망 분야 TOP5와 핵심기업 리스트
{: .wood-text}
...
- 유망 분야
  ...
  3. 멀티 클라우드, 인공지능 (41%)
  4. 사물인터넷
- 에릭슨에 따르면 2025년에는 데이터 트래픽이 현재의 5배 증가 예상

- 트래픽 발생 순위
  1. 자동차
    - 자동차와 자동차간 송수신 데이터 교환
    - 사람과 자동차
    - 사람과 도로
  2. 디지털 헬스케어
    - U-헬스케어 시장 본격 개화
    - 기업
      ...
      - 구글
        - 웨어러블 디바이스 기업 핏비트 인수
      - 아마존 
        - 원격 진료 기업 헬스 네비게이터 인수
      - 베스트 바이
        - 원격 모니터링 시스템 기업 CST 인수'
  3. 증강분석
    - 데이터를 머신러닝하여 인사이트를 도출한후 자연어로 표현
    - 데이터 분석가들이 하고 있는 일을 대체하는 서비스를 증강분석 서비스라 한다.
    - 정형 데이터인 텍스트나 숫자보다 비정형 데이터인 오디오, 이미지 분석이 많아짐
    - 기업
      - 세일즈포스
        - 비욘드코어 인수
      - 마이크로소프트
...
### ✔ 카카오 VS 네이버 누가 더 좋을까? | 데이터 3법 통과로 누가 더 수혜를 볼까?
{: .wood-text}
...
- 데이터 3법
  ...
  - 신용정보법
  - 정보통신망법
- 마이데이터 도입으로 개인정보 접근성이 좋아짐
- 개인정보보호위원회로 일원화 됨
- 개인을 구체적으로 식별할 수 없는 데이터는 개인 허락 미필요
- 개인의 민감정보의 경우 개인주도하에 기업들에게 정보 제공
- 유망기업은 핀테크
  - 네이버
    - 월 이용자 1천만
    - 월 거래액 1.4조원
